...
RELATION_MAP = {
    ...
    "disease_phenotype":            ("Disease",   "HAS_PHENOTYPE", "Phenotype"),
    "disease_disease":              ("Disease",   "RELATED_TO",    "Disease"),
    "drug_disease":                 ("Drug",      "TREATS",        "Disease"),
    "disease_drug":                 ("Disease",   "TREATED_BY",    "Drug"),
    "drug_phenotype":               ("Drug",      "AFFECTS",       "Phenotype"),
    "phenotype_disease":            ("Phenotype", "PRESENT_IN",    "Disease"),
    "contraindication":             ("Drug",      "CONTRAINDICATED_IN", "Disease"),
    "indication":                   ("Drug",      "INDICATED_FOR", "Disease"),
    "off-label use":                ("Drug",      "OFF_LABEL_FOR", "Disease"),
